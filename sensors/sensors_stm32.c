...
/**
 * lichen add: some define
 */
#define I2C3_DEV          I2C1
...
static void sensorsTask(void *param)
{
  ...
  while (1)
  {
    if (pdTRUE == xSemaphoreTake(sensorsDataReady, portMAX_DELAY))
    {
      ...
      i2cdevRead(I2C3_DEV, MPU6500_DEFAULT_ADDRESS, MPU6500_RA_ACCEL_XOUT_H, dataLen, buffer);
...
{
  Axis3f accScaled;
  // Note the ordering to correct the rotated 90潞 IMU coordinate system
...
static void sensorsInterruptInit(void)
{
  ...
  // Enable the MPU6500 interrupt on PC1
