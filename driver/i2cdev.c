...
//    status = I2C_Master_BufferWrite(I2Cx, &memAddress,  1, DMA, devAddress << 1, I2C_TIMEOUT);
  }
  if (status)
  {
...
void __attribute__((used)) DMA1_Channel5_IRQHandler(void)
{
