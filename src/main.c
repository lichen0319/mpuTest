...
void vPortSetupTimerInterrupt( void )
{
  ...
  {
    DEBUG_PRINT("SysTick Config Error!\n");
    DEBUG_PRINT("System Halting...\n");
...
//  xTaskCreate(mpu6500, "sensors task", 1024, NULL, configMAX_PRIORITIES-4, NULL);

	vTaskStartScheduler();

	DEBUG_PRINT("Never here!\n");
...
DEBUG_PRINT("Error FreeRTOS Stack Over Flow...\n");
